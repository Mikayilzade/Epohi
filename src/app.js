(function () {
  ...
  function defenseBonus(x, y) { const tile = state.map[y][x], rule=TERRAIN[tile.terrain]||{}; let bonus = Math.round((Number(rule.defenseModifier)||0)/6); if (settlementAt(x,y)) bonus += 5; if (tile.improvement && !tile.pillaged) bonus += 2; return bonus; }
